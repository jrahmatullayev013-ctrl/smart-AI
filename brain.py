...
# Hugging Face-dan olingan Access Token
...
def get_ai_answer(user_input):
    """Hugging Face modeli orqali har qanday savolga aqlli javob berish"""
    payload = {
    ...
    try:
        ...
        if isinstance(output, list) and len(output) > 0:
            ...
            return answer
        return "Kechirasiz, hozir muloqotda uzilish bo'lyapti. 😊"
